    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                <a href="{{route('main_category.create')}}" class="btn btn-info text-white"><i
                        class="fa fa-plus-circle mr-2"></i>Add Main Category</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                                ...
                                <div class="modal-dialog modal-sm" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Delete Category !!
                                            </h6>
                                        ...
                                        <div class="modal-footer">
                                            <form method="POST"
                                                action="{{route('main_category.destroy',$main_category->id)}}">
                                                @csrf
                            ...
                            <tr>
                                ...
                                <td><span class="avatar avatar-xl brround cover-image"
                                        data-image-src="{{asset('storage/'.$main_category->image)}}"></span></td>
                                <td>{{$main_category->name}}</td>
                                <td>
                                    @if($main_category->status == 'Active')
                                    <i class="fa fa-check mr-1 text-success"></i>{{$main_category->status}}
                                    @endif

                                    @if($main_category->status == 'InActive')
                                    <i class="fa fa-remove mr-1 text-danger"></i> {{$main_category->status}}
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('main_category.edit',$main_category->id)}}"
                                        class="btn btn-warning "><i class="fa fa-edit mr-1" data-toggle="tooltip"
                                            title="Edit Order"></i> </a>
