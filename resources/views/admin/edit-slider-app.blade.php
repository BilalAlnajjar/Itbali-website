...
@section('content')
<form method="POST" action="{{route('slids-app.update',$slid->id)}}" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            placeholder="type your banner title" value="{{$slid->title}}">
                        @error('title')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sub_title" name="sub_title" value="{{$slid->sub_title}}" placeholder="">
                        @error('sub_title')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4">
                        <img src="{{asset('storage/'.$slid->image)}}" alt="" class="w-full">
                    </div>
