...
<div class="row row-cards row-deck">
    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <img class="card-img-topbr-tr-0 br-tl-0" src="{{asset('storage/'.$slid->image)}}" alt="{{$slid->title}}">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-sm btn-primary" href="{{route('slid-app.edit',$slid->id)}}"><i class="fa fa-edit"></i> Edit</a>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="POST"
                action="{{route('slid-app.destroy',$slid->id)}}">
                @csrf
